 ...
 * @link     https://openapi-generator.tech
 */
class DictionaryServiceAudienceCategoryValue implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['audience_category'] = isset($data['audience_category']) ? $data['audience_category'] : null;
