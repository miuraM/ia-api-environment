...
class AdGroupServiceManualCPVBid implements ModelInterface, ArrayAccess
{
     ...
     * Sets max_cpv
     *
     * @param int|null $max_cpv <div lang=\"ja\"> 入札価格です。<br> このフィールドは、リクエストの場合は必須です。 </div> <div lang=\"en\"> Bid amount.<br> This field is required in requests. </div>
     *
     * @return $this
     */
